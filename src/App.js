    ...
    return (
      <Router >
        ...
        <Switch>
          ...
          <Route exact path='/checkout' render={() => <Checkout removeFromCart={this.removeFromCart} cart={this.state.cart} formatMoney={this.formatMoney} addToCart={this.addToCart} removeFromCart={this.removeFromCart}/> }/>
        </Switch>
      </Router>
