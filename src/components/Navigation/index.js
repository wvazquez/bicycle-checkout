  ...
  render() {
    ...
    return (
      ...
      <div className="grow">
        ...
        <SideCart editCartItem={this.props.editCartItem} removeCartItem={this.props.removeCartItem} isShoppingCartOpen={this.state.isShoppingCartOpen} toggleSideCart={this.toggleSideCart} cart={this.props.cart}/>
      </div>
    );
